...
#---------------------------Function run all of the Above on Zillow Data--------------------------
...
def wrangle_zillow():
    ...
    train, validate = train_test_split(train_and_validate)
        # Function to scale the zillow data
    train_scaled, val_scaled, test_scaled = zillow_scaler(train, validate, test)
